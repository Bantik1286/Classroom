...
const handleGradeSubmission = require('./Routes/GradeSubmission')
const handleGetGrade = require('./Routes/GetGrade')
...
app.use('/api/gradeSubmission',handleGradeSubmission)
app.use('/api/getGrade',handleGetGrade)
